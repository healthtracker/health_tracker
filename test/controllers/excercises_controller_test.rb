...
class ExcercisesControllerTest < ActionController::TestCase
  ...
  test "should create excercise" do
    assert_difference('Excercise.count') do
      post :create, excercise: { calories_burned: @excercise.calories_burned, date: @excercise.date, description: @excercise.description, excercise_type_id: @excercise.excercise_type_id }
    end
  ...
  test "should update excercise" do
    patch :update, id: @excercise, excercise: { calories_burned: @excercise.calories_burned, date: @excercise.date, description: @excercise.description, excercise_type_id: @excercise.excercise_type_id }
    assert_redirected_to excercise_path(assigns(:excercise))
  end
